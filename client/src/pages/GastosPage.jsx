...
export default function GastosPage({ setActiveItem }) {
  ...
  return (
    <div className="h-[calc(100vh-55px)] lg:h-screen w-full flex flex-col justify-center items-center font-medium px-5">
      <img src={width > 475 ? mockupDesktop : mockMobile} alt="" className={`${width > 475 ? "w-[600px] " : "w-[250px]"} ${width > 1024 && "w-[800px]"}`} />
      <p className="text-center">
        ¡Estamos trabajando en esto! 🔧 Esta sección estará disponible pronto.
